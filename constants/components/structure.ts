...
export const STRUCTURE_COMPONENTS: ComponentTemplate[] = [
    { 
        ...
        content: `<div class="builder-component-row" style="display: grid; grid-template-columns: 1fr; gap: 1rem; width: 100%; min-height: 100px;">
                <div style="${COMMON_STYLE}">Column 1</div>
              </div>` 
    },
    { 
        id: 'col-2', name: '2 Columns', category: 'structure', icon: 'columns', 
        content: `<div class="builder-component-row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; width: 100%; min-height: 100px;">
                <div style="${COMMON_STYLE}">Column 1</div>
    ...
    { 
        ...
        content: `<div class="builder-component-row" style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1rem; width: 100%; min-height: 100px;">
    ...
    { 
        ...
        content: `<div class="builder-component-row" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 1rem; width: 100%; min-height: 100px;">
    ...
    { 
        ...
        content: `<div class="builder-component-row" style="display: grid; grid-template-columns: repeat(5, 1fr); gap: 0.5rem; width: 100%; min-height: 100px;">
    ...
    { 
        ...
        content: `<div class="builder-component-row" style="display: grid; grid-template-columns: repeat(6, 1fr); gap: 0.5rem; width: 100%; min-height: 100px;">
    ...
    { 
        ...
        content: `<div class="builder-component-row" style="display: grid; grid-template-columns: 2fr 1fr; gap: 1rem; width: 100%; min-height: 100px;">
                <div style="${COMMON_STYLE}">Wide</div><div style="${COMMON_STYLE}">Narrow</div>
              </div>` 
    },
    { 
        id: 'col-1-2', name: '1/3 + 2/3', category: 'structure', icon: 'layout', 
        content: `<div class="builder-component-row" style="display: grid; grid-template-columns: 1fr 2fr; gap: 1rem; width: 100%; min-height: 100px;">
